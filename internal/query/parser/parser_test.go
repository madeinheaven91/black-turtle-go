...
func TestLessonQuery(t *testing.T) {
	testcases := []struct {
		...
		{
			"пары димитриев александр олегович",
			"пары,димитриев александр олегович,nil,nil,nil",
		},
		{
			"пары димитриев александр олегович завтра",
			"пары,димитриев александр олегович,завтра,nil,nil",
		},
	}
