...
import (
	...
	"github.com/madeinheaven91/black-turtle-go/internal/msgbuilder"
...
func LessonsHandler(ctx context.Context, b *bot.Bot, update *models.Update) {
	...
	msg := msgbuilder.BuildDayMsg(week.Days[req.Date.Weekday()-1], req.Date, resp.Group.Name)
